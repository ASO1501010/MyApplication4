...
public class Camera2BasicFragment extends Fragment
    ...
    ProgressDialogFragment progressDialog;   // ロード中画面のプログレスダイアログ作成
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                progressDialog = ProgressDialogFragment.newInstance("認証中", "しばらくお待ちください");
// Dialog表示
...
//                progressDialog = new ProgressDialog(Camera2BasicFragment.this);
//                progressDialog.setIndeterminate(true);
//                progressDialog.setCancelable(false);
//                progressDialog.setMessage("認証中...");
//                progressDialog.show();
                //new LoginAsyncHttpRequest(Camera2BasicFragment.this).execute(new Param("https://face-login.herokuapp.com/Login/compFace", bytes));
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
                mImage.close();
