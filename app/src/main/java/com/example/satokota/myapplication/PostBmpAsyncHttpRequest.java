...
public class PostBmpAsyncHttpRequest extends AsyncTask<Param, Void, String> {
    ...
    public PostBmpAsyncHttpRequest(Activity activity, School userInfo) {
        mActivity = activity;
        user = userInfo;
    }
    ...
    protected String doInBackground(Param... params) {
        ...
        try {
            ...
            String encodedImage = Base64.encodeToString(jpg.toByteArray(), Base64.DEFAULT);
            //byte[] bytes = jpg.toByteArray();

            HashMap<String, Object> jsonMap = new HashMap<>();
            jsonMap.put("level", user.level);
